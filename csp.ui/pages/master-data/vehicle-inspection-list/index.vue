<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>เพิ่มรายการตรวจสภาพรถ</span>
      </p>
      <Form
        ref="inputForm"
        :model="formItem"
      ...
      >
          ...
          >
            <Input disabled size="large" icon="ios-folder-open-outline" v-model="formItem.field4" @click></Input>
          </FormItem>
          <FormItem
            prop="field5"
            flex-xs="100"
...
export default {
  ...
  computed: {
    apiUrl() {
      return `api/v1/vehicle-inspection-list?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
