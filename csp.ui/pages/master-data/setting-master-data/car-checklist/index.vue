<template>
  <div class="component-wrapper">
    ...
    <HeaderPage :userAvatar="false" :buttonAdd="true" :divider="false">รายการตรวจสภาพรถยนต์</HeaderPage>

    <DataTable :tableColumns="tableColumns1" pageType="carchecklist" searchField="" searchValue=""></DataTable>

    <Modal v-model="modalAddData" :mask-closable="false" width="520" @on-cancel="closeModalAdd()">
      <p slot="header">
        <span>เพิ่มข้อมูลรายการตรวจสภาพรถยนต์</span>
      </p>
      <Form
        ref="inputForm"
        :model="formItem"
...
export default {
  ...
  methods: {
    ...
    async saveData() {
      ...
      let apiUrl = `api/v1/MasterData?pageType=carchecklist`
