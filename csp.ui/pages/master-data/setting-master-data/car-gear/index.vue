<template>
  <div class="component-wrapper">
    ...
    <HeaderPage :userAvatar="false" :buttonAdd="true" :divider="false">เกียร์</HeaderPage>
      ...
      <Modal v-show="modalAddData" v-model="resloveSlowInput" :mask-closable="false" width="60%" @on-cancel="closeModalAdd()">
        ...
        >
          <div layout="row" layout-wrap flex="100" flex-gt-lg="80">
            <FormItem prop="Name" :label="tableColumns1[1].title" flex="100">
...
export default {
  ...
  methods: {
    ...
    async editData(id) {
      this.itemID = id
      let apiWithQuery = `${'api/v1/MasterData/' + id + '?pageType=cargear'}`
    ...
    async saveData() {
      ...
      let apiUrl = `api/v1/MasterData?pageType=cargear`
      let apiEditMode = `${'api/v1/MasterData' + '/' + this.itemID + '?pageType=cargear'}`
