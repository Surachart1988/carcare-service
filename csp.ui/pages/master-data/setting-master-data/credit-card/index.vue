<template>
  <div class="component-wrapper">
    ...
    <HeaderPage :userAvatar="false" :buttonAdd="true" :divider="false">บัตรเครดิต</HeaderPage>

    <DataTable :tableColumns="tableColumns1" pageType="creditcard" searchField="" searchValue=""></DataTable>

    <Modal v-model="modalAddData" :mask-closable="false" width="480" @on-cancel="closeModalAdd()">
      <p slot="header">
        <span>เพิ่มข้อมูลบัตรเครดิต</span>
      </p>
      <Form
        ref="inputForm"
        :model="formItem"
...
export default {
  ...
  methods: {
    ...
    async saveData() {
      ...
      let apiUrl = `api/v1/MasterData?pageType=creditcard`
