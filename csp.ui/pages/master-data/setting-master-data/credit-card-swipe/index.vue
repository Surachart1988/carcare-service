<template>
  <div class="component-wrapper">
    ...
    <HeaderPage :userAvatar="false" :buttonAdd="true" :divider="false">รูปแบบการรูดบัตร</HeaderPage>

    <DataTable :tableColumns="tableColumns1" pageType="creditcardswipe" searchField="" searchValue=""></DataTable>

    <Modal v-model="modalAddData" :mask-closable="false" width="480" @on-cancel="closeModalAdd()">
      <p slot="header">
        <span>เพิ่มข้อมูลรูปแบบการรูดบัตร</span>
      </p>
      <Form
        ref="inputForm"
        :model="formItem"
...
export default {
  ...
  methods: {
    ...
    async saveData() {
      ...
      let apiUrl = `api/v1/MasterData?pageType=creditcardswipe`
