<template>
  <div class="component-wrapper">
    ...
    <HeaderPage :userAvatar="false" :buttonAdd="true" :divider="false">เหตุผลการปรับลดปรับเพิ่ม</HeaderPage>

    <DataTable :tableColumns="tableColumns1" pageType="reasondecinc" searchField="" searchValue=""></DataTable>

    <Modal v-model="modalAddData" :mask-closable="false" width="520" @on-cancel="closeModalAdd()">
      <p slot="header">
        <span>เพิ่มข้อมูลเหตุผลการปรับลดปรับเพิ่ม</span>
      </p>
      <Form
        ref="inputForm"
        :model="formItem"
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        ...
        {
          title: 'เหตุผลการปรับลดปรับเพิ่ม',
          key: 'name',
          align: 'center',
          sortable: true
        },
  ...
  methods: {
    ...
    async saveData() {
      ...
      let apiUrl = `api/v1/MasterData?pageType=reasondecinc`
