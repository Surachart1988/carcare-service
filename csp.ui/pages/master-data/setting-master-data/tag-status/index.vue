<template>
  <div class="component-wrapper">
    ...
    <HeaderPage :userAvatar="false" :buttonAdd="true" :divider="false">รายการติดตามหลังการรับบริการ</HeaderPage>

    <DataTable :tableColumns="tableColumns1" pageType="tagstatus" searchField="" searchValue=""></DataTable>

    <Modal v-model="modalAddData" :mask-closable="false" width="500" @on-cancel="closeModalAdd()">
      <p slot="header">
        <span>เพิ่มข้อมูลรายการติดตามหลังการรับบริการ</span>
      </p>
      <Form
        ref="inputForm"
        :model="formItem"
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        ...
        {
          title: 'รายการติดตามหลังการรับบริการ',
          key: 'name',
          align: 'center',
          sortable: true
        },
  ...
  methods: {
    ...
    async saveData() {
      ...
      let apiUrl = `api/v1/MasterData?pageType=tagstatus`
