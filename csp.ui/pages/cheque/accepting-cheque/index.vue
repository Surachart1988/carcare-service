<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างบันทึกการรับเช็ค</span>
      </p>
      Hi !
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        ...
        {
          title: "ชื่อลูกค้า/ชื่อผู้จำหน่าย",
          key: "field6",
          align: "center",
          sortable: true,
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/acceptingcheque?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
