<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบเบิกวัสดุสิ้นเปลือง</span>
      </p>
      Hi !
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบเบิกวัสดุสิ้นเปลือง",
          key: "code",
          align: "center",
          sortable: true,
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/suppliesslip?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
