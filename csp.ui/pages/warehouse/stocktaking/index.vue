<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบเช็คสต๊อกสินค้า</span>
      </p>
        ...
        >
          ...
          >
            ...
            <FormItem
              ...
              flex-offset-gt-md="0"
            >
              <RadioGroup size="large" v-model="formItem.field6">
                <Radio label="ทั้งหมด">ทั้งหมด</Radio>
                <Radio label="มีในสต๊อก">มีในสต๊อก</Radio>
                <Radio label="ไม่มีในสต๊อก">ไม่มีในสต๊อก</Radio>
                <Radio label="ติดลบ">ติดลบ</Radio>
              </RadioGroup>
            </FormItem>
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        ...
        {
          title: "รหัสผู้เช็คสต๊อกสินค้า",
          key: "contactID",
          align: "center",
          sortable: true,
        },
        {
          title: "ชื่อผู้เช็คสต๊อกสินค้า",
          key: "contactName",
          align: "center",
          sortable: true,
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/stocktaking?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
