<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบรับเข้าสินค้า</span>
      </p>
      ...
      >
        ...
        <section flex-xs="100" flex-sm="100" flex-md="100" flex-gt-md="33" />
        ...
        >
          <FormItem
            ...
            flex-offset-gt-md="0"
          >
            <Input size="large" v-model="formItem.field9"
...
export default {
  ...
  computed: {
    apiUrl() {
      return `api/v1/importorder?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
