<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบปรับลดปรับเพิ่มสินค้า</span>
      </p>
          ...
          >
            ...
            >
              <Select
                ...
                placeholder="เลือกประเภทการปรับ"
              >
                <Option value="test01">test01</Option>
              </Select>
            </FormItem>
      ...
      <div slot="footer">
        <div layout="row" layout-align="center center">
          <Button type="success" shape="circle" size="large" @click="handleSubmit('inputForm')"
            >บันทึก</Button
          >
          <Button type="error" shape="circle" size="large" @click="closeModalAdd()"
            >ยกเลิก</Button
          >
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบปรับลดปรับเพิ่มสินค้า",
          key: "code",
          align: "center",
          sortable: true,
        },
        ...
        {
          title: "รหัสผู้ปรับปรุง",
          key: "contactID",
          align: "center",
          sortable: true,
        },
        {
          title: "ชื่อผู้ปรับปรุง",
          key: "contactName",
          align: "center",
          sortable: true,
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/updatestock?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
