  ...
  <div class="component-wrapper">
    ...
    >
      ...
      <template slot-scope="{ row, index }" slot="link2">
        <nuxt-link to="#"><Icon type="ios-search" /></nuxt-link>
      </template>
    ...
    >
      <p slot="header">
        <span>สร้างใบหักภาษี ณ ที่จ่าย</span>
      </p>
      Hi !
...
export default {
  ...
  computed: {
    apiUrl() {
      return `api/v1/withholdingsheet?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
