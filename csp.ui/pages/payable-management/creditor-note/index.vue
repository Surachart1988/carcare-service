<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบลดหนี้เจ้าหนี้</span>
      </p>
      Hi !
...
export default {
  ...
  computed: {
    apiUrl() {
      return `api/v1/creditornote?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
