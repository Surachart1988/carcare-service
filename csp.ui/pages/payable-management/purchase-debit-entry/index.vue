<template>
  <div class="component-wrapper">
    <HeaderPage>
      ใบเพิ่มหนี้เจ้าหนี้ (ตามใบรับเข้าสินค้า)
    ...
    >
      <p slot="header">
        <span>สร้างใบเพิ่มหนี้เจ้าหนี้ (ตามใบรับเข้าสินค้า)</span>
      </p>
      Hi !
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบเพิ่มหนี้เจ้าหนี้",
          key: "code",
          align: "center",
          sortable: true,
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/purchasedebitentry?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
