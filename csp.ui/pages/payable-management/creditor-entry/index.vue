<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบลดหนี้เจ้าหนี้ (ตามใบรับเข้า)</span>
      </p>
      Hi !
...
export default {
  ...
  computed: {
    apiUrl() {
      return `api/v1/creditorentry?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
