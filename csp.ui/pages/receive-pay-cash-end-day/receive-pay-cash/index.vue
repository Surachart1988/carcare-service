<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างบันทึกการรับ-จ่ายเงินสด</span>
      </p>
      ...
      >
        <section layout="row" layout-align="center center" flex="100">
          <FormItem
            label="วันที่"
            prop="field1"
            flex-xs="100"
        ...
        <section layout="row" layout-align="center center" flex="100">
            ...
            flex-offset-gt-md="5"
          >
            <RadioGroup layout="row" size="large" v-model="formItem.field3">
              <Radio label="รับเงินสด">รับเงินสด</Radio>
              <Radio label="จ่ายเงินสด">จ่ายเงินสด</Radio>
            </RadioGroup>
             </FormItem>
            </section>
            <section layout="row" layout-align="center center" flex="100">
            <FormItem
            label="รายละเอียดการรับ-จ่ายเงิน"
            label-width="220"
            prop="field4"
            flex-xs="100"
            flex-sm="100"
            ...
            flex-offset-gt-md="5"
          >
            <Input type="textarea" :autosize="{minRows: 3,maxRows: 5}" size="large" v-model="formItem.field4"></Input>
             </FormItem>
            </section>
            <section layout="row" layout-align="center center" flex="100">
            <FormItem
          ...
          >
            ...
            flex-offset-gt-md="5"
          >
            <Input type="textarea" :autosize="{minRows: 3,maxRows: 5}" size="large" v-model="formItem.field6"></Input>
             </FormItem>
            </section>
        </Form>
...
export default {
  ...
  data() {
    return {
      ruleValidate: {
        ...
        field3: [{ required: true, message: 'กรุณากรอกข้อมูล', trigger: 'change' }],
  ...
  computed: {
    apiUrl() {
      return `api/v1/receivepaycash?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
