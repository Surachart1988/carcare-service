<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบเพิ่มหนี้ลูกหนี้ (ตามใบเสร็จ)</span>
      </p>
      Hi !
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบเพิ่มหนี้ลูกหนี้",
          key: "code",
          align: "center",
          sortable: true,
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/debitnotereceipt?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
