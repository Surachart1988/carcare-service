<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบบันทึกค่าใช้จ่าย</span>
      </p>
      Hi !
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        ...
        {
          title: "สร้างแบบประเมินความพึงพอใจลูกค้า",
          slot: "action",
          width: 150,
          align: "center",
        },
  ...
  computed: {
    apiUrl() {
      return `api/v1/satisfactionsurveyform?pageType=null&pageNumber=${this.dataCurrentPage}&pageSize=${this.dataPageSize}&orderAsc=${this.dataSortBy.order}&orderBy=${this.dataSortBy.key}`;
    },
  },
  mounted() {
    this.getData();
