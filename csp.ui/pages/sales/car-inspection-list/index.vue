<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบตรวจสอบสภาพรถยนต์</span>
      </p>
      ...
      >
        ...
        <section flex="100" style="margin-bottom: 30px">
          <h2 style="color: #009345">ราคาการตรวจเช็ครถ</h2>
        </section>
        ...
        >
          <Select
            ...
            placeholder="เลือกรายการตรวจเช็ค"
            flex="100"
          >
        ...
        <section layout="row" flex="100">
          <section flex-xs="100" flex-sm="100" flex-md="100" flex-gt-md="30">
            <Upload
              ref="upload"
          ...
          <section flex-xs="100" flex-sm="100" flex-md="100" flex-gt-md="70">
            <Table
              stripe
              size="large"
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบตรวจสอบสภาพรถยนต์",
          key: "code",
          align: "center",
          sortable: true,
        },
