    ...
    >
      ...
      >
        <FormItem
          ...
          flex-offset-gt-md="0"
        >
          <RadioGroup size="large" v-model="formItem.field1">
            <Radio label="จากใบส่งของชั่วคราว">จากใบส่งของชั่วคราว</Radio>
            <Radio label="จากใบเสร็จรับเงิน/ใบกำกับภาษี">จากใบเสร็จรับเงิน/ใบกำกับภาษี</Radio>
          </RadioGroup>
        </FormItem>
        <FormItem
          label="เลขที่เอกสาร"
          ...
          flex-offset-gt-md="0"
        >
          <Input size="large" v-model="formItem.field2" icon="ios-folder-open-outline"></Input>
        </FormItem>
        <FormItem
          label="รหัสลูกค้า"
          prop="field3"
        ...
        <FormItem
          ...
          flex-offset-gt-md="0"
        >
          <Input disabled size="large" v-model="formItem.field8"></Input>
        </FormItem>
        <section
          layout="row"
          flex-xs="100"
        ...
        <FormItem
          ...
          :label-width="120"
        >
          <Input disabled size="large" v-model="formItem.field10"></Input>
        </FormItem>
        </section>
        <FormItem
          label="เครดิตคงเหลือ"
            ...
            <section layout="row" style="margin-top: 30px">
              ...
              <section flex="45">
                <FormItem label="รวมเงิน" prop="field10">
                  <Input disabled size="large" v-model="formItemTab1.field10"
                    ><span slot="append">บาท</span></Input
                  >
                </FormItem>
                <FormItem label="ภาษีมูลค่าเพิ่ม" prop="field11">
                  <Input disabled size="large" v-model="formItemTab1.field11"
                    ><span slot="append">บาท</span></Input
                  >
                </FormItem>
                <FormItem label="ยอดรวมสุทธิ" prop="field12">
                  <Input disabled size="large" v-model="formItemTab1.field12"
                    ><span slot="append">บาท</span></Input
                  >
                </FormItem>
              </section>
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบกำกับภาษีเต็มรูป",
          key: "code",
          align: "center",
          sortable: true,
        },
