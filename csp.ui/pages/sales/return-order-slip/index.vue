<template>
  <div class="component-wrapper">
    ...
    >
      <p slot="header">
        <span>สร้างใบลดหนี้/รับคืนสินค้า</span>
      </p>
      ...
      >
          ...
          >
            ...
            >
              <Input
                disabled
                size="large"
                v-model="formItemModalList.field3"
              ></Input>
            </FormItem>
            <FormItem
              label="DOT"
            ...
            >
              <Input
                disabled
                size="large"
                v-model="formItemModalList.field4"
              ></Input>
            </FormItem>
            <FormItem
              label="หน่วยซื้อ"
            ...
            >
              <Input
                disabled
                size="large"
                v-model="formItemModalList.field5"
              ></Input>
            </FormItem>
            <FormItem
              label="จำนวน"
              ...
              flex-offset-gt-md="0"
            >
              <Input size="large" v-model="formItemModalList.field6"></Input>
            </FormItem>
            <FormItem
              label="ราคา/หน่วย"
              prop="field7"
              ...
              flex-offset-gt-md="0"
            >
              <Input size="large" v-model="formItemModalList.field7"></Input>
            </FormItem>
          </Form>
          <div slot="footer">
            <div layout="row" layout-align="center center">
        ...
        <section layout="row" layout-align="end" flex="100" style="padding-bottom: 20px">
          <Button
            flex-xs="100"
            flex-sm="100"
            flex-md="100"
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns1: [
        {
          title: "เลขที่ใบลดหนี้/รับคืนสินค้า",
          key: "code",
          align: "center",
          sortable: true,
        },
